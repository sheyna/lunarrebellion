...
var outerSectorGC6 = new OuterSector("Outer Sector: GC-6", "outerSectorGC6", "General Construction", "GC-6", true);
var outerSectorLW12 = new OuterSector("Outer Sector: LW-12", "outerSectorLW12", "Lumber and Wood Production", "LW-12", true);
var outerSectorRM9 = new OuterSector("Outer Sector: RM-9", "outerSectorRM9", "Regolith Mining", "RM-9", true);
var outerSectorRD1 = new OuterSector("Outer Sector: RD-1", "outerSectorRD1", "Research and Development", "RD-1", false);
var outerSectorRD4 = new OuterSector("Outer Sector: RD-4", "outerSectorRD4", "Research and Development", "RD-4", false);
var outerSectorTS1 = new OuterSector("Outer Sector: TS-1", "outerSectorTS1", "Technical Services", "TS-1", false);
var outerSectorTS2 = new OuterSector("Outer Sector: TS-2", "outerSectorTS2", "Technical Services", "TS-2", false);
var outerSectorTS76 = new OuterSector("Outer Sector: TS-76", "outerSectorTS76", "Technical Services", "TS-76", false);
var outerSectorWS1 = new OuterSector("Outer Sector: WS-1", "outerSectorWS1", "Waste Salvage", "WS-1", true);
